...
import TodoSidebarButton from "./TodoSidebarButton";
  ...
  return (
    <>
      ...
      <div className=" space-y-1">
        {sideMenus.map((el) => (
          <TodoSidebarButton key={el.text} text={el.text} icon={el.icon}>
            <p>24</p>
          </TodoSidebarButton>
        ))}
      </div>

      <div className="h-px w-full border-b border-white-light dark:border-[#1b2e4b] my-5 "></div>

      <div className=" space-y-1">
        <h1 className=" text-light-gray text-normal mb-3">Tags</h1>
        <button className="  w-full text-green-600 text-normal font-semibold  flex justify-between items-center bg-slate-100 rounded-md   px-4 py-2 ">
        ...
        <button className="  w-full text-yellow-600 text-normal font-semibold  flex justify-between items-center hover:bg-slate-100 rounded-md duration-300 hover:scale-95   px-4 py-2 ">
          <div className=" flex items-center gap-2">
            <svg
              width="15"
              height="15"
              ...
              fill="yellow"
              xmlns="http://www.w3.org/2000/svg"
              className="fill-success shrink-0 hover:scale-95"
            >
              <path
                d="M8.01731 8.01736C11.3506 4.68402 13.0173 3.01736 15.0884 3.01736C17.1594 3.01736 18.8261 4.68402 22.1594 8.01736C25.4927 11.3507 27.1595 13.0174 27.1594 15.0884C27.1594 17.1595 25.4928 18.8262 22.1594 22.1595C18.8261 25.4928 17.1594 27.1595 15.0884 27.1594C13.0173 27.1595 11.3506 25.4928 8.01731 22.1595C4.68397 18.8262 3.01731 17.1595 3.01734 15.0884C3.01729 13.0174 4.68401 11.3507 8.01731 8.01736Z"
                stroke="currentColor"
            ...
            <span className="hover:scale-95 ">Low</span>
          </div>
        </button>

        <button className="  w-full text-blue-600 text-normal font-semibold  flex justify-between items-center hover:bg-slate-100 rounded-md duration-300 hover:scale-95   px-4 py-2 ">
          <div className=" flex items-center gap-2">
            <svg
              width="15"
              height="15"
            ...
            <span className="hover:scale-95 ">Medium</span>
          </div>
        </button>

        <button className="  w-full text-red-600 text-normal font-semibold  flex justify-between items-center hover:bg-slate-100 rounded-md duration-300 hover:scale-95   px-4 py-2 ">
          <div className=" flex items-center gap-2">
            <svg
              width="15"
              height="15"
            ...
            <span className="hover:scale-95 ">Hight</span>
          </div>
        </button>

        <button className="  w-full text-blue-400 text-normal font-semibold  flex justify-between items-center hover:bg-slate-100 rounded-md duration-300 hover:scale-95   px-4 py-2 ">
          <div className=" flex items-center gap-2">
            <svg
              width="15"
              height="15"
            ...
            <span className="hover:scale-95 ">Update</span>
          </div>
        </button>
      </div>
    </>
