    ...
    menu: [
      {
        ...
        icon: (
          <svg
            className="shrink-0 text-slate-500  group-hover:text-sky-600 pointer-events-none"
            width="25"
            height="25"
            viewBox="0 0 24 24"
            fill="none"
    ...
    menu: [
      {
        ...
        subMenu: ["Profile", "Account Setting"],
        height: 140,
      },

      {
        ...
        subMenu: ["Knowledge Base", "Faq", "Error", "Maintanence"],
        height: 205,
      },
